            ...
            if '"gKDw6b"' in str(i):
                ...
                if data:
                    if data[0]:
                        ...
                        headlines_data = [heading, link, link_href, newspapername, news_time]
                        headlines.append({"news": {"title": headlines_data[0], "subTitle": headlines_data[1], "provider": headlines_data[3], "time": headlines_data[4], "url": headlines_data[2]}})
                        del headlines_data
